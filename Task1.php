...
<p style="text-align: center; color: #343434; font-weight: 500; margin-top: 45px;">Don't have an acount? <br>Register now !</p>
                    <button type="button" class="btn" onclick="openRegister()" style="margin-top: 10px;">I'm New Here</button>
                ...
                <div class="card-back">
                    ...
                    <form action="" method="POST">
                        ...
                        <p style="text-align: center; color: #343434; font-weight: 500; margin-top: 10px;">Already have an acount? <br>Login here!</p>
                        <button type="button" class="btn" onclick="openLogin()" style="margin-top: 5px;">I've an account</button>
